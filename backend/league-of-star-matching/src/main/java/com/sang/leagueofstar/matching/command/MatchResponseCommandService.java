...
import com.sang.leagueofstar.matching.domain.service.MatchResponseResultService;
 ...
 *
 * <p>세션 상태 변경은 {@link MatchResponseResultService}에 위임하며,
...
public class MatchResponseCommandService {
    ...
    private final MatchResponseResultService matchResponseProcessor;
