...
import com.sang.smite.matching.domain.service.MatchPairingService;
    ...
    public void processMatching() {
        ...
        try {
            ...
            if (!locked) {
                ...
                log.debug("[MatchEngineScheduler] 다른 인스턴스가 스캔 중이므로 이번 사이클을 건너뜁니다.");
                return;
            }
            ...
            log.warn("[MatchEngineScheduler] 락 획득 대기 중 인터럽트가 발생했습니다.", e);
        } finally {
