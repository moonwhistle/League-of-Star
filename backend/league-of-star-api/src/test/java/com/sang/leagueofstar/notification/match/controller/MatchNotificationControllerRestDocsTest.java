package com.sang.leagueofstar.notification.match.controller;

import com.sang.leagueofstar.common.path.notification.NotificationPath;
...
import com.sang.leagueofstar.notification.match.service.MatchNotificationService;
                ...
                .apply(document("notification-match-stream",
                        resource(com.epages.restdocs.apispec.ResourceSnippetParameters.builder()
                                ...
                                .description("""
                                        ...
                                        Result mapping:
                                        - `MATCHED / BOTH_ACCEPTED / GO_TO_GAME_WAITING / game={gameRoomId, webSocketUrl}`
