...
public final class SseNotificationMetricNames {
    ...
    /** Pub/Sub 메시지 대상 유저가 현재 인스턴스에 연결되어 있던 횟수 (Counter) -> sse_notification_dispatch_local_hits_total */
    public static final String DISPATCH_LOCAL_HITS = "sse.notification.dispatch.local.hits";

    /** Pub/Sub 메시지 대상 유저가 현재 인스턴스에 연결되어 있지 않던 횟수 (Counter) -> sse_notification_dispatch_local_misses_total */
    public static final String DISPATCH_LOCAL_MISSES = "sse.notification.dispatch.local.misses";
